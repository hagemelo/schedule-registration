...
export class Migrations1713782012765 implements MigrationInterface {
  name = 'Migrations1713782012765';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Candidato" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "cpf" character varying NOT NULL, "cpf_responsavel" character varying NOT NULL, "tel_responsavel" character varying NOT NULL, "email_responsavel" character varying NOT NULL, "nome_responsavel" character varying NOT NULL, "ano_escolar" "public"."Candidato_ano_escolar_enum" NOT NULL, "nome_responsavel" character varying NOT NULL, "posto_graduacao" "public"."Candidato_posto_graduacao_enum" NOT NULL, "itinerario_informativo" "public"."Candidato_itinerario_informativo_enum" NOT NULL, CONSTRAINT "PK_6c345e61a38768cdd24232da44e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
